...
## Example
ReLU network has zig-zag inference result, while others (tanh & Swish) have smooth approximations. This is due to their natures, or continuity to be exact (ReLU ~ $C^{0}$, tanh & Swish ~ $C^{\infty}$). 
